df <- tibble::tibble(
  ...
  q1n5 = c(0, 2, 3) |> haven::labelled(c(ch1=1, ch2=2, ch3 = 3, ch4=4)),
  q1n6 = c(0, NA, 3) |> haven::labelled(c(ch1=1, ch2=2, ch3 = 3, ch4=4)),
...
dfq <- tibble::tribble(
  ...
  "mcg with NA & exclusive",           "mcg", "q1n1 q1n2 q1n3 q1n6", NA,          "1 2",
